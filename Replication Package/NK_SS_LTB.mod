// Fiscal Theory in NK framework (Simple) with Long-term Bond

var pi x i v s r rn q;

varexo eps_s eps_i;

parameters sigma beta kappa R phi_i phi_s pi_bar i_bar omega;
