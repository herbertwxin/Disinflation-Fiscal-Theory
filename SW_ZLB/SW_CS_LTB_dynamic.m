function [residual, g1, g2, g3] = SW_CS_LTB_dynamic(y, x, params, steady_state, it_)
%
...
residual(4)= lhs-rhs;
lhs =y(38);
rhs =T37*(y(4)+params(44)*params(42)*y(74)+1/T44*y(36))+y(58);
residual(5)= lhs-rhs;
lhs =y(36);
rhs =(-y(42))+y(56)*1/T62+params(47)/(params(47)+1-params(13))*y(71)+T74*y(72);
residual(6)= lhs-rhs;
lhs =y(37);
rhs =y(56)+T57/(1+T57)*y(3)+1/(1+T57)*y(73)+T90*(y(40)-y(75))-y(42)*T62;
residual(7)= lhs-rhs;
lhs =y(39);
...
residual(15)= lhs-rhs;
lhs =y(49);
rhs =y(58)+T37*(y(7)+params(44)*params(42)*y(79)+1/T44*y(47));
residual(16)= lhs-rhs;
lhs =y(47);
rhs =y(56)*1/T62+(-y(54))+y(81)-params(5)+params(47)/(params(47)+1-params(13))*y(76)+T74*y(77);
residual(17)= lhs-rhs;
lhs =y(48);
rhs =y(56)+T57/(1+T57)*y(6)+1/(1+T57)*y(78)+T90*(y(51)-y(80))-T62*(y(54)-(y(81)-params(5)));
residual(18)= lhs-rhs;
lhs =y(50);
...
residual(20)= lhs-rhs;
lhs =y(52)-params(5);
rhs =T215*(params(44)*params(42)*(y(81)-params(5))+params(21)*(y(9)-params(5))+y(43)*T231)+y(60);
residual(21)= lhs-rhs;
lhs =y(53);
rhs =T37*y(10)+T240*y(82)+(y(9)-params(5))*params(19)/(1+params(44)*params(42))-(y(52)-params(5))*(1+params(44)*params(42)*params(19))/(1+params(44)*params(42))+(y(81)-params(5))*T240+T268*(params(23)*y(51)+T120*y(48)-T123*y(6)-y(53))+y(61);
residual(22)= lhs-rhs;
lhs =y(54);
...
residual(33)= lhs-rhs;
lhs =y(65);
rhs =y(57)+T374*y(21)+y(68)-params(40)-(y(52)-params(5))-y(66);
residual(34)= lhs-rhs;
lhs =y(66);
rhs =params(58)*y(22)+(y(52)-params(5))*params(59)-x(it_, 8);
residual(35)= lhs-rhs;
lhs =params(11)*y(67);
rhs =y(22)-y(66);
residual(36)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(5,4)=(-T37);
  g1(5,38)=1;
  g1(5,74)=(-(params(44)*params(42)*T37));
  g1(5,58)=(-1);
  g1(6,71)=(-(params(47)/(params(47)+1-params(13))));
  g1(6,36)=1;
  g1(6,72)=(-T74);
  g1(6,42)=1;
  g1(6,56)=(-(1/T62));
  ...
  g1(16,7)=(-T37);
  g1(16,49)=1;
  g1(16,79)=(-(params(44)*params(42)*T37));
  g1(16,58)=(-1);
  g1(17,76)=(-(params(47)/(params(47)+1-params(13))));
  g1(17,47)=1;
  g1(17,77)=(-T74);
  g1(17,81)=(-1);
  g1(17,54)=1;
  ...
  g1(21,52)=1;
  g1(21,81)=(-(params(44)*params(42)*T215));
  g1(21,60)=(-1);
  g1(22,6)=(-(T268*(-T123)));
  g1(22,48)=(-(T120*T268));
