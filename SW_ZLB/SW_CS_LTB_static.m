function [residual, g1, g2, g3] = SW_CS_LTB_static(y, x, params)
%
...
residual(33)= lhs-rhs;
lhs =y(42);
rhs =y(34)+y(42)*T334+y(45)-params(40)-(y(29)-params(5))-y(43);
residual(34)= lhs-rhs;
lhs =y(43);
rhs =params(58)*y(44)+(y(29)-params(5))*params(59)-x(8);
residual(35)= lhs-rhs;
lhs =params(11)*y(44);
rhs =y(44)-y(43);
residual(36)= lhs-rhs;
...
T398 = 1-(T55/(1+T55)+1/(1+T55));
T400 = 1/(1-T55)-T55/(1-T55);
  g1(1,11)=(-params(9));
  g1(1,18)=(-(1-params(9)));
  g1(1,32)=1;
  g1(2,10)=1;
  ...
  g1(35,44)=(-params(58));
  g1(36,43)=1;
  g1(36,44)=params(11)-1;
  g1(37,2)=(-1);
  g1(37,45)=1;
  g1(38,45)=1;
  g1(38,46)=(-(params(61)-1));
  g1(39,4)=1;
  g1(40,5)=1;
  g1(41,6)=1;
  g1(42,7)=1;
