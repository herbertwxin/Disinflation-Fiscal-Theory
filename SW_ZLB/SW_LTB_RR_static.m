function [residual, g1, g2, g3] = SW_LTB_RR_static(y, x, params)
%
...
residual(33)= lhs-rhs;
lhs =y(41);
rhs =params(58)*(y(34)+y(41)+y(42)-params(40)-(y(29)-params(5))-y(44));
residual(34)= lhs-rhs;
lhs =y(42);
rhs =y(2);
residual(35)= lhs-rhs;
lhs =y(42)-params(40);
rhs =params(59)*y(43)-y(43);
residual(36)= lhs-rhs;
lhs =y(44);
rhs =y(44)*0.85+x(8);
residual(37)= lhs-rhs;
...
T387 = 1-(T55/(1+T55)+1/(1+T55));
T389 = 1/(1-T55)-T55/(1-T55);
  g1(1,11)=(-params(9));
  g1(1,18)=(-(1-params(9)));
  g1(1,32)=1;
  g1(2,10)=1;
  ...
  g1(34,29)=params(58);
  g1(34,34)=(-params(58));
  g1(34,41)=1-params(58);
  g1(34,42)=(-params(58));
  g1(34,44)=params(58);
  g1(35,2)=(-1);
  g1(35,42)=1;
  g1(36,42)=1;
  g1(36,43)=(-(params(59)-1));
  g1(37,44)=0.15;
  g1(38,4)=1;
  g1(39,5)=1;
  g1(40,6)=1;
