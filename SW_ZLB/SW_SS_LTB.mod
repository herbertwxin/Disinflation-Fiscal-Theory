...
var   labobs robs pinfobs dy dc dinve dw  ewma epinfma  zcapf rkf kf pkf    cf invef yf labf wf rrf mc zcap rk k pk    c inve y lab pinf w r a  b g qs  ms  spinf sw kpf kp rr v s rn q;    
...
ctrend 
conster cg cgamma clandap cbetabar cr cpie crk cw cikbar cik clk cky ciy ccy crkky cwhlc cwly R crpis omega;
...
// Resource constraint
          ...
          v   = cbeta^(-1)*v(-1) + (rn - conster) - (pinf- constepinf) + g - s;
