...
var pi x i v s r vstar sstar; //rn q us;

varexo eps_s eps_i;

parameters sigma beta kappa R phi_i phi_s pi_bar i_bar gamma; // alpha etas omega
...
beta* vstar = vstar(-1) - sstar;

sstar = R* vstar(-1) + phi_s*(pi-pi_bar) + eps_s;

// Debt and latent debt

beta* v = v(-1) + (i - i_bar) - (pi - pi_bar) - sstar - s;
