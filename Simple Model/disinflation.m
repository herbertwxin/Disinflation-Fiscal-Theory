function [sr_value_rounded, nominal_interest_rate, real_interest_rate, inflation, output_gap, debt, surplus] = disinflation(model_name, options_,M_,oo_, CPIE, CRPI, RR, Ta, Tstar)
